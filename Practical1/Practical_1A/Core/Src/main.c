...
uint8_t ledPattern_Mode1[8] = {0x01, 0x02, 0x04, 0x08,
						 0x10, 0x20, 0x40, 0x80}; // Contains the Bitmask for mode 1 PA1
uint8_t ledPattern_Mode2[8] = ~ledPattern_Mode1; // Contains Bitmask for Mode 2.
...
int main(void)
{
  ...
  while (1)
  {
    ...
    // TODO: Check pushbuttons to change timer delay
	  if (HAL_GPIO_ReadPin(Button0_GPIO_Port, Button0_Pin) == GPIO_PIN_RESET)// i used original variable name
	  {
		  if (currentDelay == 0)
		  {
